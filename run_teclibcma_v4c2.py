...
rosetta_scripts_path = os.path.expanduser("~/SYSX0008/rosetta.binary.linux.release-315/main/source/bin/rosetta_scripts.static.linuxgccrelease")
nstruct = 1 # Normally 35
...
def run_flex_ddg( name, input_path, input_pdb_path, chains_to_move, nstruct_i ):
    output_directory = os.path.join( 'output_teclibcma_v4c2', os.path.join( name, '%02d' % nstruct_i ) )
    ...
    flex_ddg_args = [
        ...
        'mutate_resfile_relpath=' + os.path.abspath( os.path.join( input_path, 'nataa_mutations.resfile.v4c2' ) ),
